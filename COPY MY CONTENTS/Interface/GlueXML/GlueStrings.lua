...
ARM = "ARM";
ARMOR = "Armor";
ASSERTIONS_ENABLED_BUILD = RELEASE_BUILD;
...
AUTH_BANNED_URL = "http://127.0.0.1/termsofuse.shtml";
...
AUTH_DB_BUSY_URL = "http://127.0.0.1/serverstatus";
...
AUTH_NO_TIME_URL = "http://127.0.0.1/account";
...
AUTH_PARENTAL_CONTROL_URL = "http://127.0.0.1/account";
...
AUTH_SUSPENDED_URL = "http://127.0.0.1/termsofuse.shtml";
...
BILLING_TEXT2 = "Trial options were removed from this client, however the server registers this account as having trial flags.";
...
LOGIN_BANNED = "<html><body><p align=\"CENTER\">This World of Warcraft account has been closed and is no longer available for use.  Please go to <a href=\"http://127.0.0.1/misc/banned.html\">http://www.worldofwarcraft.com/misc/banned.html</a> for further information.</p></body></html>";
...
LOGIN_ERROR = "Error";
LOGIN_EXPIRED = "<html><body><p align=\"CENTER\">Your game account subscription has expired. Please visit <a href=\"http://127.0.0.1/account\">www.worldofwarcraft.com/account</a> to purchase. more time.</p></body></html>";
...
LOGIN_MALFORMED_ACCOUNT_NAME = "<html><body><p align=\"CENTER\">The information you have entered is not valid.  Please check the spelling of the account name and password.  If you need help in retrieving a lost or stolen password and account, see <a href=\"http://127.0.0.1/loginsupport\">www.worldofwarcraft.com/loginsupport</a> for more information.</p></body></html>";
LOGIN_NOTIME = "<html><body><p align=\"CENTER\">You have used up your prepaid time for this account. Please visit <a href=\"http://127.0.0.1/account\">www.worldofwarcraft.com/account</a> to purchase more to continue playing.</p></body></html>";
...
LOGIN_SUSPENDED = "<html><body><p align=\"CENTER\">This World of Warcraft account has been temporarily suspended. Please go to <a href=\"http://127.0.0.1/misc/banned.html\">http://www.worldofwarcraft.com/misc/banned.html</a> for further information.</p></body></html>";
LOGIN_TOO_FAST = "You have too many login attempts. Please try again in a few minutes.";
LOGIN_TRIAL_EXPIRED = "<html><body><p align=\"CENTER\">Your trial subscription has expired. Please visit <a href=\"http://127.0.0.1/account\">www.worldofwarcraft.com/account</a> to upgrade your account.</p></body></html>";
...
PTR_AE_BUILD = RELEASE_BUILD;
PTR_RELEASE_BUILD = RELEASE_BUILD;
PVP_PARENTHESES = "(PVP)";
...
QUEUE_FCM_URL = "http://127.0.0.1/account";
...
REALM_HELP_FRAME_URL = "<a href=\"http://127.0.0.1/\">www.worldofwarcraft.com</a>";
...
REALM_LIST_SUCCESS = "Realm list displaying";
...
REGEN = "REGEN %.0f";
RELEASE_BUILD = "Emerald Nightmare Client: (4/6/2012) 28 (Release)";
...
WORLD_OF_WARCRAFT = "Emerald Nightmare: The Rise of Lordaeron";
