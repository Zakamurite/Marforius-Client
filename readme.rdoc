...
This is a unsecured client for scriptwriters, addonwriters, and people who want to customize their client and have full 
control over what it does, or exploit on private servers.


= Installation & Use

The only thing you have to do to it is import your MPQ files into it, and only your MPQ files.
This means both your data and locale folder, this has <b>NOT BEEN TESTED WITH OTHER LOCALES THAN enUS</b>
...
You can take credit for Marforius-Client, and in fact, I encourage you to <b>not give me any credit for this what-so-ever.</b>

<b>DO NOT release this on ac-web nor mmowned/ownedcore OR ANY OTHER WEBSITE</b> without <b>branding it as your own.</b>

Additional terms beyond these two clauses can be found at: http://sam.zoy.org/wtfpl



= Contact the Developers  

irc.freenode.net #ArcEmu
